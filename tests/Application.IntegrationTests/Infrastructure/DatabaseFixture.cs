...
using TagDossier.Application.Tags.Queries.GetTags;
...
namespace TagDossier.IntegrationTests.Infrastructure
{
    public class DatabaseFixture : TestFixture
    {
        ...
        private static void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMediatR(typeof(GetTagsQueryHandler));
        }
        ...
        private static void SetCurrentUser(ApplicationUser user)
            => FakeCurrentUserService.SetCurrentUser(user);

        public static async Task<ApplicationUser> RunAsNewUserAsync()
        {
        ...
        public static void RunAs(ApplicationUser user)
            => SetCurrentUser(user);
    }
}